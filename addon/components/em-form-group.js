  ...
  didReceiveAttrs(/*arg*/) {
    ...
    if(this.get('form') && !this.get('hasSetForm')){
      this.set('hasSetForm', true);
       ...
       Ember.deprecate('Please use the new form.input helper defined in 1.0.0beta10', /*!!arg.newAttrs.form*/this.get('form'), {id: 'ember-rapid-forms.yielded-form', until: 'v1.0'});
